-- =============================================================================
-- Demo data — a worked example of the full capital cycle, for local
-- development and training only.
--
-- NEVER run this against production. It creates four staff accounts whose
-- password is published in this repository.
--
-- Settings and expense categories are NOT here: the application needs those to
-- run, so they are applied by migration 0010 instead and reach production
